  ...
  function (Controller, JSONModel, MessageBox, MessageToast, Fragment, ColumnListItem, Label, Token, formatter) {
    ...
    return Controller.extend("project1.controller.View1", {
      ...
      onInit: function () {
        ...
        this._oRootPath = jQuery.sap.getModulePath("project1"); // your resource root
      ...
      onVoyTyHelpRequest: function (oEvent) {
        ...
        this._oVoyTyHelpDialog = sap.ui.xmlfragment("project1.view.VoyageTypes", this);
      ...
      onCarTyHelpRequest: function (oEvent) {
        ...
        let oColModel = new JSONModel(aCols);
        this._oCarTyHelpDialog = sap.ui.xmlfragment("project1.view.CargoTypes", this);
      ...
      onCargoUnitHelpRequest: function (oEvent) {
        ...
        let oColModel = new JSONModel(aCols);
        this._oCargoUnitHelpDialog = sap.ui.xmlfragment("project1.view.CargoUnit", this);
      ...
      onCurTyHelpRequest: function (oEvent) {
        ...
        let oColModel = new JSONModel(aCols);
        this._oCurTyHelpDialog = sap.ui.xmlfragment("project1.view.CurrencyTypes", this);
      ...
      onBidTyHelpRequest: function (oEvent) {
        ...
        let oColModel = new JSONModel(aCols);
        this._oBidTyHelpDialog = sap.ui.xmlfragment("project1.view.BiddingTypes", this);
